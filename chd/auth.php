...
<head>
    ...
    <meta name="description" content="Cozy Home Decor - Login or Register">
    <meta name="keywords" content="Home Decor, Login, Register, Cozy Home Decor">
    <title>Login/Register - Cozy Home Decor</title>
    <!-- Google Font: Caudex -->
...
<body>
    <div class="auth-section">
        ...
        <div class="auth-container">
            <div class="auth-card">
                <h1>COZY HOME DECOR</h1>
                <h2>Welcome Back!</h2>
                <p>Please login or register to continue</p>
                <div class="auth-buttons">
                    <a href="login.php" class="auth-btn">Login</a>
                    <a href="register.php" class="auth-btn">Register</a>
                    <a href="admin_login.php" class="auth-btn">Admin</a> <!-- Admin Login Link -->
                </div>
            </div>
        </div>
    </div>
